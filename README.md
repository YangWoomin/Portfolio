...
#### 3.4 C프로그래밍 2 (2014년 1학기) : C언어 학습 및 실습(C)

#### 3.5 C++프로그래밍 (2014년 1학기) : C++언어 학습 및 실습(C++)

#### 3.6 마이크로프로세서 및 실습 (2014년 2학기) : ATmega128로 마이크로프로세서 및 주변장치 제어 학습 및 실습(C)

#### 3.7 자바프로그래밍 (2014년 2학기) : 자바언어 학습 및 실습(Java)

#### 3.8 자료구조 및 실습 (2014년 2학기) : stack, queue, tree, graph 학습 및 실습(C)

#### 3.9 윈도우즈프로그래밍 (2014년 2학기) : 간략한 MFC 프로그래밍 학습 및 실습(실질적으로 open API 활용 프로젝트 진행)

#### 3.10 운영체제 (2015년 1학기) : 기본적인 운영체제 이론 학습, 가상메모리, 스케줄링 등

#### 3.11 컴퓨터구조 (2015년 1학기) : 기본적인 컴퓨터구조 이론 학습, 명령사이클, 입출력, 캐시메모리, 내외부메모리 등

#### 3.12 컴퓨터네트워크 (2015년 1학기) : 인터넷 프로토콜 기반 각 계층 프로토콜 학습

#### 3.13 알고리즘 및 실습 (2015년 1학기) : sorting, dynamic programming, traveling salesman problem 등 학습

#### 3.14 데이터베이스 및 실습 (2015년 1학기) : 기본적인 데이터베이스 이론 학습

#### 3.15 컴퓨터그래픽스 및 실습 (2015년 2학기) : openGL 기반 그래픽스 프로그래밍 학습 및 실습(C)

#### 3.16 시스템프로그래밍 (2015년 2학기) : Linux 프로그래밍 학습 및 실습(C), makefile, multiprocess, multithread 등

#### 3.17 데이터베이스프로그래밍 (2015년 2학기) : MSSQL과 Netbeans 연동으로 데이터베이스 모델링 및 구현(Java)

#### 3.18 소프트웨어공학 (2015년 2학기) : 구조적 개발 방법론 학습 및 실습, 객체지향 개발 방법론 학습

#### 3.19 모바일시스템프로그래밍 (2016년 1학기) : 안드로이드 센서 관련 API 학습 및 실습(Java)

#### 3.20 네트워크프로그래밍 (2016년 1학기) : TCP/IP, UDP, multithread 기반 네트워크 프로그래밍 학습 및 실습(C)

#### 3.21 IoT개론 및 실습 (2016년 1학기) : IoT 기반 프로젝트 진행(Java, Python)

#### 3.22 임베디드응용 및 실습 (2016년 1학기) : GPIO 제어 리눅스 디바이스 드라이버 모듈 작성(C, Python, Java, PHP)

#### 3.23 스마트네트워크 및 실습 (2016년 2학기) : wireshark, packet tracer를 통한 전반적인 네트워크 분야 학습 및 실습

#### 3.24 졸업설계 1, 2 (2016년) : 졸업작품으로 Unity 엔진 기반 모바일 FPS 게임 제작
